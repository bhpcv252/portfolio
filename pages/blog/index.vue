    ...
    <div class="blog" id="blog">
        <div class="container">
            ...
            <div class="wrapper">
                ...
                <div class="filters">
                    <!-- Search Filter -->
                    <input v-model="searchQuery" type="text" placeholder="Search posts..." @input="changePage(1)" />
    ...
    meta: [
        {
            name: "description",
            content:
                "Explore ongoing projects, discover experiments, and stay updated with the latest insights and developments.",
        },
        {
            name: "ogDescription",
            content:
